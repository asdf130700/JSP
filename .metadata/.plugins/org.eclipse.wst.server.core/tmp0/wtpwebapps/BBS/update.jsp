...
<%-- <%		
	...
	<div class ="container">
		...
		<form method="post" action="updateAction.jsp?bbsID=<%= bbsID %>">
			...
			<thead>
				<tr>
					<th colsapn="2" style="background-color: #eeeeee; text-align: center;">게시판 글수정 양식</th>
				</tr>
			</thead>
			<tbody>
				<tr>
				<td><input type="text" class="form-control" placeholder="작성자" name="userID" maxlength="20"value="<%=bbs.getUserID() %>"></td>
				</tr> 
				<tr>
